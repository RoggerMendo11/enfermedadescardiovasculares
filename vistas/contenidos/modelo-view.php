...
<script language="JavaScript">
  function redireccionar() {
    ...
    setTimeout("location.href='http://localhost/Soluciones/vistas/contenidos/vista-view.php?a=<?php echo $inicio ?>&b=<?php echo $fin ?>&c=<?php echo $codigo ?>&d=<?php echo $procentaje ?>'", 2000);
