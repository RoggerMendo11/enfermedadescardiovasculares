			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="<?php echo SERVERURL;?>enfermedad/"><i class="zmdi zmdi-labels zmdi-hc-fw"></i> Enfermedad</a>
						</li>
						<li>
							<a href="<?php echo SERVERURL;?>diagnostico/"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Diagnostico</a>
						</li>
						<li>
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="<?php echo SERVERURL;?>paciente/"><i class="zmdi zmdi-male-female zmdi-hc-fw"></i> Pacientes</a>
						</li>
					</ul>
				</li>
				<li>
