...
if ($peticionAjax) {
	...
	class vistapruebaModelo extends mainModel{
		...
		protected function datos_empresa_modelo($codigo){
			$query=mainModel::conectar()->prepare("SELECT * FROM empresa WHERE EmpresaCodigo=:Codigo");
